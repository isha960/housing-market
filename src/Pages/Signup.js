...
const Signup = () => {
  ...
  const onSubmitHandler= async(e)=>{
     ...
     try {
      ...
      delete formDataCopy.password; // passwords shoud not be stored in database for some security reasons.
  ...
  return (
    ...
    <div className='col-md-6 signup-container-col-2'>
        <form className='bg-light p-4' onSubmit={onSubmitHandler}>
            <h3 className='bg-dark p-2 mt-2 text-light text-center'>SignUp</h3>
    <div className="mb-3">
  ...
  <span className='ms-4'>Already User</span> <Link to="/signin">Login</Link>
  <div className='mt-3'>
    <OAuth/>
  </div>
    </form>
