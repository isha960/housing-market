...
const onEdit = (listingId) => {
  ...
  <div className="mb-3">
    ...
    <input type="email" className="form-control" id="email" value={email} onChange={onChange} aria-describedby="emailHelp" disabled={!changeDetails}/>
  </div>
...
<Link to="/create-listings">
    <FaArrowCircleRight color='primary'/> &nbsp;Sell or Rent your Home
  </Link>
</div>
</div>
</div>
